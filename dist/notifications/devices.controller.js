...
let DevicesController = class DevicesController {
    ...
    async register(token, platform, language, userId) {
        if (!token && arguments[0]?.token) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Register a device push token (for guests or users)' }),
    (0, swagger_1.ApiBody)({
        schema: {
            type: 'object',
            properties: {
    ...
    __param(0, (0, common_1.Body)('pushToken')),
